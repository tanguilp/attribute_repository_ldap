defmodule AttributeRepositoryLdap do
  ...
  defp build_eldap_filter({:pr, %AttributePath{
    attribute: attribute,
    sub_attribute: nil
  }})
  do
  ...
  defp build_eldap_filter({:eq, %AttributePath{
    attribute: attribute,
    sub_attribute: nil
  }, value})
  do
  ...
  defp build_eldap_filter({:ne, %AttributePath{
    attribute: attribute,
    sub_attribute: nil
  }, value})
  do
  ...
  defp build_eldap_filter({:ge, %AttributePath{
    attribute: attribute,
    sub_attribute: nil
  }, value})
  do
  ...
  defp build_eldap_filter({:le, %AttributePath{
    attribute: attribute,
    sub_attribute: nil
  }, value})
  do
  ...
  defp build_eldap_filter({:gt, %AttributePath{
    attribute: attribute,
    sub_attribute: nil
  }, value})
  do
  ...
  defp build_eldap_filter({:lt, %AttributePath{
    attribute: attribute,
    sub_attribute: nil
  }, value})
  do
  ...
  defp build_eldap_filter({:co, %AttributePath{
    attribute: attribute,
    sub_attribute: nil
  }, value})
  do
  ...
  defp build_eldap_filter({:sw, %AttributePath{
    attribute: attribute,
    sub_attribute: nil
  }, value})
  do
  ...
  defp build_eldap_filter({:ew, %AttributePath{
    attribute: attribute,
    sub_attribute: nil
  }, value})
  do
  ...
  @spec process_eldap_search_result({:eldap_search_result, list(), list()}, AttributeRepository.run_opts())
  ...
  @spec attribute_value_to_string(String.t(), charlist() | [charlist()], AttributeRepository.run_opts())
  ...
  defp attribute_value_to_string(attribute_name, attribute_value, run_opts) do
    case LDAPoolex.Schema.get(run_opts[:instance], to_string(attribute_name)) do
      nil -> # no information from schema
      ...
      %{single_valued: true, syntax: syntax} ->
        attribute_value
        |> List.first() # theorically, it should be the only element
  ...
  defp to_elixir_value(value, @data_type_generalized_time <> _), do: AttributeRepositoryLdap.Utils.DateParser.to_datetime(to_string(value))
  ...
  defp to_ldap_string_representation(%DateTime{} = val), do: DateTime.to_iso8601(val, :basic) |> String.replace("T", "") |> to_charlist()
